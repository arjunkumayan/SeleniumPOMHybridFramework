...
public class AppConstants {
	...
	// ****************TIMEOUTS***********************
	public static int DEFAULT_TIMEOUTS = 20;
	...
	public final static String LOGIN_SHOW_PASSWORD_LINK_TEXT = "Show Password";
	public final static String LOGIN_FORGOT_PASSWORD_LINK_TEXT = "Forgot my password";
