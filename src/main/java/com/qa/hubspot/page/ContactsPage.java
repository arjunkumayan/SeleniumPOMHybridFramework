...
public class ContactsPage extends BasePage {
	...
	By createContactFormButton = By.xpath("//button[@data-selenium-test='base-dialog-confirm-btn']//span[text()='Create contact']");
	...
	public String getContactsPageTitle() {
	  ...
	  //Thread.sleep(5000); elementUtil.waitForElementPresent(createContactButton);
